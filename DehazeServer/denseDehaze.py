...
weight_path = "/Graduate/DehazeServer/weight/densehaze_generator_in512_ep85_loss227.h5"
...
if __name__ == "__main__":
    ...
    img_src = glob.glob("/Graduate/DehazeServer/input/IN.jpg")
    ...
    for img_path in img_src:
        ...
        cv2.imwrite(f"/Graduate/DehazeServer/outputs/OUT.jpg", rgb_de_test)
