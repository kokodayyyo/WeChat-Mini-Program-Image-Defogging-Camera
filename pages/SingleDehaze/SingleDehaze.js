// pages/SingleDehaze/SingleDehaze.js
...
Page({
  ...
  getCode() {   //从后端获取处理后的图片
   ...
   DealImg1: function(){ //发送指令调用室内模型处理图片
    wx.showToast({
      title: '加载中...',
      icon: 'loading',
      duration: 15000//持续的时间
    })
    wx.request({
      url: 'http://49.235.112.59:5000/three',
      method: "POST",
      header: {
        　'content-type': "application/x-www-form-urlencoded",
      },
  ...
  DealImg2: function(){ //发送指令调用室外模型处理图片
    wx.showToast({
      title: '加载中...',
      icon: 'loading',
      duration: 15000//持续的时间
    ...
    wx.request({
      url: 'http://49.235.112.59:5000/four',
      method: "POST",
      header: {
        　'content-type': "application/x-www-form-urlencoded",
      },
  ...
  DealImg3: function(){ //发送指令调用浓雾模型处理图片
    wx.showToast({
      title: '加载中...',
      icon: 'loading',
      duration: 15000//持续的时间
    ...
    wx.request({
      url: 'http://49.235.112.59:5000/five',
      method: "POST",
      header: {
        　'content-type': "application/x-www-form-urlencoded",
      },
  ...
  DealImg4: function(){ //发送指令调用非均匀雾模型处理图片
    wx.showToast({
      title: '加载中...',
      icon: 'loading',
      duration: 15000//持续的时间
    ...
    wx.request({
      url: 'http://49.235.112.59:5000/six',
      method: "POST",
      header: {
        　'content-type': "application/x-www-form-urlencoded",
      },
